    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Guided paddle, pub at the end', note: 'Several local outfits run guided sea-kayak trips down the full seven miles of the lake, Glenridding to Pooley Bridge, in stable tandem boats — around three hours, no experience needed, and you finish at a pub.', link: 'https://www.ullswateroutdooradventures.co.uk/paddle-walk-ullswater-way', linkLabel: 'Full-day paddle & walk ↗' },
        ],
      },
      {
