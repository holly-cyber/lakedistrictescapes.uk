...
export const BOOKINGS = [
  ...
  { property: 'primrose-cottage', channel: 'Airbnb', code: 'HMC9JTZP2Y', guest: 'Georgie Stoppard', booked: '2026-08-20', start: '2026-08-23', end: '2026-08-25', nights: 2, gross: 242.25, fee: 46.5, cleaning: 0, net: 203.5, payout: '2026-08-25', currency: 'GBP' },
  { property: 'primrose-cottage', channel: 'Airbnb', code: 'HMSHP82TS5', guest: 'Elliot Pye', booked: '2026-08-23', start: '2026-08-25', end: '2026-08-27', nights: 2, gross: 242.25, fee: 46.5, cleaning: 0, net: 203.5, payout: '2026-08-27', currency: 'GBP' },
...
export const EXPENSES = [
  ...
  },
  {
    ...
    date: '2026-08-03',
    vendor: 'TK Maxx',
    category: 'Furnishings & Equipment',
    note: 'Bedding, duvets, sheets, shower caddy & bin (order 45223657)',
    amount: 239.94,
    vat: 39.99,
    businessPct: 100,
    startup: true,
  ...
  },
  {
    ...
    vendor: 'TK Maxx',
    category: 'Furnishings & Equipment',
    note: 'Duvet sets & feather duvets (order 45292477)',
    amount: 166.98,
    vat: 27.83,
    businessPct: 100,
    startup: true,
  ...
  },
  {
    ...
    vendor: 'TK Maxx',
    category: 'Furnishings & Equipment',
    note: 'Towels, pillowcases, duvet cover & cushions (order 45473352)',
    amount: 159.88,
    vat: 26.65,
    businessPct: 100,
    startup: true,
